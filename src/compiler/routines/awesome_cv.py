...
\\newcommand*{\\subentrydatestyle}[1]{{\\fontsize{7pt}{1em}\\bodyfontlight\\slshape\\color{darktext} #1}}
...
\\newcommand*{\\letterdatestyle}[1]{{\\fontsize{9pt}{1em}\\bodyfontlight\\slshape\\color{darktext} #1}}
